...
\textcolor{red}{ADD THIS AS A FIGURE}
...
SVM was the model with the best performance with the default parameters. 
We tried to improve the model by changing the parameters.
